...
const GrowthIllustration = () => (
  <div className="relative w-44 h-44 mx-auto flex items-center justify-center">
    ...
    {/* Label contenido - ajustado para que no se salga */}
    ...
    return (
      <div className="min-h-screen bg-[#F7F6F5] flex flex-col items-center justify-center p-4">
        ...
        <div className="max-w-md w-full bg-white rounded-[2.5rem] shadow-2xl p-10 border border-bokara-grey/5 animate-fade-in overflow-hidden">
            <h2 className="text-3xl font-bold text-bokara-grey mb-2 text-center">Comenzar desde cero</h2>
            <p className="text-bokara-grey/50 text-sm mb-8 font-medium text-center">Dale un nombre a tu nueva organización para empezar.</p>
  ...
  return (
    <div className="min-h-screen bg-[#F7F6F5] flex flex-col items-center justify-center p-6 sm:p-10 animate-fade-in relative overflow-x-hidden">
      ...
      <div className="absolute top-8 left-8 z-30">
           <button onClick={handleBack} className="flex items-center gap-2 text-bokara-grey/50 hover:text-bokara-grey font-bold transition-all group px-4 py-2 hover:bg-white rounded-xl shadow-sm border border-transparent hover:border-bokara-grey/5">
                <ArrowLeftIcon className="w-5 h-5 transform group-hover:-translate-x-1 transition-transform" />
      ...
      <div className="w-full max-w-6xl mt-12 sm:mt-0">
        <div className="mb-12 text-center sm:text-left animate-fade-in">
            ...
            <p className="text-bokara-grey/40 font-medium mt-3 text-lg">Crea tu nueva organización o únete a una existente.</p>
        </div>
          ...
          <div className="flex flex-col gap-6 group animate-fade-in">
            ...
            <div className="bg-white rounded-[2.5rem] shadow-xl border border-bokara-grey/5 p-10 flex flex-col min-h-[560px] h-full hover:shadow-2xl hover:translate-y-[-4px] transition-all relative overflow-hidden">
              <div className="relative z-10 flex flex-col h-full">
                ...
                {/* Illustration Area - Contenido centrado y contenido */}
                ...
                <div className="relative z-20 flex flex-col items-center mt-auto">
                  ...
                  <div className="mt-4">
                      <span className="bg-[#FFF3E0] text-[#E65100] px-3 py-1 rounded-lg text-[9px] font-bold uppercase border border-orange-100 shadow-sm inline-block transform hover:rotate-2 transition-transform cursor-default">¿AUTÓNOMO?</span>
                  </div>
                </div>
              </div>
            </div>
