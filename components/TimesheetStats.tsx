...
import { ClockIcon, ActivityLogIcon } from './Icons';
...
interface TimesheetStatsProps {
  ...
  daysCovered: number;
  topPerformer?: { name: string; hours: number }; // mantenido por compatibilidad, ya no se usa
}
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 animate-fade-in">
      ...
      <div className="bg-white p-6 rounded-xl shadow-md border border-bokara-grey/10 flex items-center gap-6 relative overflow-hidden">
        <div
          ...
          style={{ background: `conic-gradient(#91A673 ${workPercentage}%, #AE8F60 0)` }}
        >
        ...
        <div>
          ...
          <div className="flex flex-col gap-1 mt-1">
            <div className="flex items-center gap-2 text-xs">
              <div className="w-2 h-2 rounded-full bg-lucius-lime" />
              <span>Trabajo</span>
            </div>
            <div className="flex items-center gap-2 text-xs">
              <div className="w-2 h-2 rounded-full bg-wet-sand" />
