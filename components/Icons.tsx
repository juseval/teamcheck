...
const iconClass = "w-5 h-5 text-dark-hunter-green/70";
const sideNavIconClass = "w-6 h-6 transition-colors";
...
export const CalendarIcon: React.FC<{className?: string}> = ({ className = sideNavIconClass}) => (
...
export const ClockIcon: React.FC<{className?: string}> = ({ className = sideNavIconClass}) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const TeamIcon: React.FC<{className?: string}> = ({ className = sideNavIconClass}) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2m8-10a4 4 0 100-8 4 4 0 000 8zm12 10v-2a4 4 0 00-3-3.87" />
    </svg>
);

export const PowerIcon: React.FC<{className?: string}> = ({ className = iconClass }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.636 5.636a9 9 0 1012.728 0M12 3v9" />
    </svg>
);

export const DashboardIcon: React.FC<{className?: string}> = ({ className = sideNavIconClass}) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
    </svg>
);

export const TimesheetIcon: React.FC<{className?: string}> = ({ className = sideNavIconClass}) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
    </svg>
);

export const ActivityLogIcon: React.FC<{className?: string}> = ({ className = sideNavIconClass}) => (
...
export const SettingsIcon: React.FC<{className?: string}> = ({ className = sideNavIconClass}) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const ChronoLogIcon: React.FC<{className?: string}> = ({ className = sideNavIconClass}) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 3v1m0 16v1m8.66-15.66l-.7.7M4.04 19.96l-.7.7M21 12h-1M4 12H3m15.66 8.66l-.7-.7M4.04 4.04l-.7-.7"/>
...
export const SortUpIcon: React.FC<{className?: string}> = ({ className = 'w-4 h-4' }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20"><path d="M3 3a1 1 0 000 2h14a1 1 0 100-2H3zm0 4a1 1 0 100 2h14a1 1 0 100-2H3zm0 4a1 1 0 100 2h14a1 1 0 100-2H3zm0 4a1 1 0 100 2h14a1 1 0 100-2H3z"></path></svg>
);
